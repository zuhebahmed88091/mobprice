...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
			...
			tMain2 = '<div class="box box-default">' +
                        '<div class="box-header with-border">{goBack}\n{cancel}\n{remove}\n{move}\n{upload}\n{browse}\n</div>' +
						'<div class="box-body">' +
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '        {download} {upload} {zoom} {delete} {other}' +
                '    </div>\n' +
                '</div>\n' +
                '{drag}\n' +
                '<div class="clearfix"></div>';
        ...
        _renderMain: function () {
            ...
            return self.mainTemplate.setTokens({
                ...
                'move': self._renderButton('move'),
                'goBack': self._renderButton('goBack'),
        ...
        _renderButton: function (type) {
			...
			if (type === 'browse') {
				...
				css += ' fileinput-' + type + ' fileinput-' + type + '-button';
			}
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-primary btn-sm pull-right',
		moveIcon: '<i class="glyphicon glyphicon-trash"></i>',
        moveClass: 'btn btn-success btn-sm pull-right',
        goBackIcon: '<i class="glyphicon glyphicon-trash"></i>',
        goBackClass: 'btn btn-info btn-sm',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btn btn-default btn-danger',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-danger',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btn btn-success btn-sm pull-right',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadExtraData: {},
